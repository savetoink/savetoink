...
require (
	...
	github.com/markusmobius/go-trafilatura v1.12.3-0.20250921033241-67c3f2a1ca17
...
require (
	...
	github.com/testcontainers/testcontainers-go/modules/dynamodb v0.40.0 // indirect
